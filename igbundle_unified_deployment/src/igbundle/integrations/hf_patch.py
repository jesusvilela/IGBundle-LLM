...
def wrap_hf_candidate(model, adapter_config, adapter_class=IGBundleAdapter):
    """
...
class StateCollector:
    ...
    def attach(self, model):
        ...
        # Find all IGBundleAdapters (V1 and V2)
        target_classes = ('IGBundleAdapter', 'GeometricIGBundleAdapter')
        for name, module in model.named_modules():
            if type(module).__name__ in target_classes:
